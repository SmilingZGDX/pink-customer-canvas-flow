  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-pink-50 p-4">
      <Card className="w-full max-w-2xl p-8 space-y-6">
        <h2 className="text-3xl font-semibold text-[#F699CD] text-center">Address Details</h2>
        <div className="space-y-4">
          <div className="space-y-2">
            <Label className="text-[#F699CD]">Street Address</Label>
            <Textarea placeholder="Enter your street address" />
          </div>
          <div className="space-y-2">
            <Label className="text-[#F699CD]">City</Label>
            <Input type="text" placeholder="Enter your city" />
          </div>
          <div className="space-y-2">
            <Label className="text-[#F699CD]">State/Province</Label>
            <Input type="text" placeholder="Enter your state or province" />
          </div>
          <div className="space-y-2">
            <Label className="text-[#F699CD]">Postal Code</Label>
            <Input type="text" placeholder="Enter your postal code" />
          </div>
          <div className="space-y-2">
            <Label className="text-[#F699CD]">Country</Label>
